...
- (instancetype)init
{
    ...
    if (self) {
        ...
        self.avatars = @{ kJSQDemoAvatarIdSystem : jobsImage,
        ...
        self.users = @{ kJSQDemoAvatarIdJobs : kJSQDemoAvatarDisplayNameJobs,
                        ...
                        kJSQDemoAvatarIdSystem : kJSQDemoAvatarDisplayNameJobs };
...
- (void)loadFakeMessages
{
    ...
    if ([NSUserDefaults longMessageSetting]) {
        JSQMessage *reallyLongMessage = [JSQMessage messageWithSenderId:kJSQDemoAvatarIdSystem
...
- (void)addPhotoMediaMessage
{
    ...
    JSQMessage *photoMessage = [JSQMessage messageWithSenderId:kJSQDemoAvatarIdSystem
                                                   displayName:kJSQDemoAvatarDisplayNameSystem
                                                         media:photoItem];
...
- (void)addLocationMediaMessageCompletion:(JSQLocationMediaItemCompletionBlock)completion
{
    ...
    JSQMessage *locationMessage = [JSQMessage messageWithSenderId:kJSQDemoAvatarIdSystem
                                                      displayName:kJSQDemoAvatarDisplayNameSystem
                                                            media:locationItem];
...
- (void)addVideoMediaMessage
{
    ...
    JSQMessage *videoMessage = [JSQMessage messageWithSenderId:kJSQDemoAvatarIdSystem
                                                   displayName:kJSQDemoAvatarDisplayNameSystem
                                                         media:videoItem];
